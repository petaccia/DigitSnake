      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">DigitSnake simplifie le numérique pour tous, avec un focus sur l'accessibilité et le support personnalisé.</p>
          </div>
          <div>
            <h3 className="text-lg font-bold mb-4 text-secondary">Navigation</h3>
            <ul className="space-y-2">
              <li><a href="/" className="hover:text-octonary transition-colors duration-300">Accueil</a></li>
              <li>
        ...
        <div className="mt-8 border-t border-primary/30 pt-4 text-center text-sm text-gray-400">
          <p>Conçu avec passion par DigitSnake pour simplifier le numérique.</p>
        </div>
        <div>
          <p className="text-lg font-medium text-octonary text-center mt-16">&copy; {new Date().getFullYear()} DigitSnake. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
