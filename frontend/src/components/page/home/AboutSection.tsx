  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-primary/90 to-primary/80">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-white drop-shadow-lg">À Propos de DigitSnake</h2>
